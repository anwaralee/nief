...
<div class="listing"><div class="label">Content</div><div class="fields"><textarea name="content" class="required"><?php if($content['content']) echo $content['content'];?></textarea></div><div class="clear"></div></div>
...
<div class="listing"><div class="label">Meta Description</div><div class="fields"><textarea name="desc" class="required"><?php if($content['meta_desc']) echo $content['meta_desc'];?></textarea></div><div class="clear"></div></div>
